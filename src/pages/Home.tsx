...
const vehicles = [
    {
        name: 'Toyota Prado',
        tagline: 'The Ultimate Adventure SUV',
        image: '/assets/vehicles/prado.jpg',
        specs: ['7 Seats', '4WD', 'Diesel', 'Automatic'],
        price: 'From KES 12,000/day',
        accent: 'from-emerald-500 to-teal-600',
    },
    {
        name: 'Range Rover',
        tagline: 'Peerless Luxury & Presence',
        image: '/assets/vehicles/range-rover.jpg',
        specs: ['5 Seats', 'AWD', 'Petrol', 'Automatic'],
        price: 'From KES 50,000/day',
        accent: 'from-amber-500 to-orange-600',
    },
    {
        name: 'Toyota Harrier',
        tagline: 'Refined Urban Crossover',
        image: '/assets/vehicles/harrier.jpg',
        specs: ['5 Seats', '2WD', 'Hybrid', 'Automatic'],
        price: 'From KES 8,000/day',
        accent: 'from-blue-500 to-indigo-600',
    },
    {
        name: 'Toyota Fielder',
        tagline: 'Efficient Everyday Executive',
        image: '/assets/vehicles/fielder.jpeg',
        specs: ['5 Seats', '2WD', 'Petrol', 'Automatic'],
    ...
    },
    {
        ...
        specs: ['5 Seats', 'AWD', 'Petrol', 'Automatic'],
        price: 'From KES 7,000/day',
        accent: 'from-cyan-500 to-blue-600',
    },
    {
        name: 'Lexus RX',
        tagline: 'Premium Comfort Redefined',
        image: '/assets/vehicles/lexus.jpg',
        specs: ['5 Seats', 'AWD', 'Hybrid', 'Automatic'],
        price: 'From KES 9,000/day',
...
const features = [
    {
        ...
        description: 'Prado, Range Rover, Harrier, Fielder & more — meticulously maintained',
        features: ['Executive SUVs', 'Luxury Sedans', 'Hybrid Vehicles', '7-Seater Options'],
        icon: KeyIcon,
    },
    {
...
const testimonials = [
    {
        ...
        comment: 'Vision Wan transformed our corporate travel program. The Prado fleet is impeccable and the service is unmatched.',
        rating: 5,
    ...
    },
    {
        ...
        comment: 'From the Range Rover to the Harrier, every vehicle I\'ve rented has been flawless. Truly seamless global mobility.',
        rating: 5,
    ...
    },
    {
        ...
        comment: 'Their attention to detail and premium fleet aligns perfectly with our brand standards. The Fielder is a hidden gem.',
        rating: 5,
...
const HomePage: React.FC = () => {
    ...
    /* Auto-play modal video once it mounts */
    useEffect(() => {
        if (videoModal && modalVideoRef.current) {
        ...
        <div className="min-h-screen bg-white overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {stats.map((stat, index) => (
                            <div
                                key={index}
                                className="group relative bg-white rounded-2xl p-7 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-4 border border-gray-100"
                            >
            ...
            <div className="py-28">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Video preview strip — click opens modal */}
                    <button
                        type="button"
                        onClick={openVideo}
                        ...
                        <img
                            ...
                            onError={(e) => {
                                (e.currentTarget as HTMLImageElement).src =
                                    'https://img.youtube.com/vi/c2sj7kjzmaY/hqdefault.jpg';
                            }}
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            From the rugged Toyota Prado to the elegant Range Rover — choose the perfect vehicle for
                            your needs.
                        </p>
                    </div>
                                ...
                                <div className="p-6">
                                    <div className="flex flex-wrap gap-2 mb-5">
                                        {vehicle.specs.map((spec, idx) => (
                                            <span
                                                key={idx}
                                                className="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs font-semibold rounded-lg group-hover:bg-[#FF6B35]/10 group-hover:text-[#FF6B35] transition-colors duration-300"
                                            >
                                                {spec}
                                            </span>
                                        ))}
                    ...
                    <div className="text-center mt-14">
                        <Link
                            to="/fleet"
                            className="inline-flex items-center px-8 py-4 bg-gray-900 text-white font-bold rounded-2xl hover:bg-[#FF6B35] transition-all duration-300 transform hover:-translate-y-1 shadow-xl"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {services.map((service, index) => (
                            <Link
                                key={index}
                                to={service.link}
                                className="group relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 flex items-start gap-5"
                            >
            ...
            <div className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        {/* Video preview — click opens modal */}
                        <button
                            type="button"
                            onClick={openVideo}
                            className="relative w-full rounded-3xl overflow-hidden shadow-2xl group cursor-pointer block text-left"
                        ...
                        >
                            <img
                                ...
                                onError={(e) => {
                                    (e.currentTarget as HTMLImageElement).src =
                                        'https://img.youtube.com/vi/uvGFXy3glRg/hqdefault.jpg';
                                }}
                                ...
                                <div className="relative h-full bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-[0_10px_40px_-15px_rgba(15,23,42,0.15)] hover:shadow-[0_25px_60px_-15px_rgba(255,107,53,0.35)] border border-slate-100 transition-all duration-500 transform group-hover:-translate-y-3 overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-1 mb-5">
                                        {[...Array(testimonial.rating)].map((_, i) => (
                                            <SolidStar
                                                key={i}
                                                className="h-5 w-5 text-amber-400 drop-shadow-[0_0_6px_rgba(251,191,36,0.35)]"
                                            />
                                        ))}
                                        <span className="ml-2 text-xs font-bold text-slate-400 tracking-wider">
                                            5.0
                                        </span>
                                    </div>
                                ...
                                content: (
                                    <>
                                        <a
                                            ...
                                            className="text-lg font-bold text-white hover:text-[#FF6B35] transition-colors duration-300 block mt-4 tracking-wide"
                                        >
                                            +254 (705) 336 311
                                        </a>
                                        <a
                                            href="tel:+447397549590"
                                            className="text-lg font-bold text-white hover:text-[#FF6B35] transition-colors duration-300 block mt-1 tracking-wide"
                                        >
                                            +44 (7397) 549 590
                                        </a>
                                    </>
            ...
            {/* Global keyframes — add once if not already present */}
            <style>{`
                @keyframes fadeUp {
            ...
            {/* ────────────── VIDEO MODAL (opened by both video sections) ────────────── */}
            {videoModal && (
                <div
                ...
                >
                    ...
                    >
                        <button
                            onClick={closeVideo}
                            className="absolute top-4 right-4 z-10 p-2.5 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/25 transition-colors"
                        ...
                        <video
                            ...
                            loop
                            playsInline
                            poster="https://images.unsplash.com/photo-1594502184342-2e12f877aa73?auto=format&fit=crop&w=1920&q=80"
                        >
                            <source
                                src="https://assets.mixkit.co/videos/preview/mixkit-white-suv-driving-on-a-mountain-road-42821-large.mp4"
                                type="video/mp4"
                            />
