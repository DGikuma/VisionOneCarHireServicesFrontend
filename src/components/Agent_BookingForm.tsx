...
export interface Agent_BookingFormRef {
    validateStep: () => Promise<boolean>;
    resetForm: () => void;
}

export interface Agent_BookingFormProps {
    activeStep: number;
    onNextStep: () => void;
    onPrevStep: () => void;
    onComplete?: () => void;
...
const API_URL = `${API_BASE_URL}/api/agent_bookings`;
const AMEND_API_URL = `${API_BASE_URL}/api/agent_bookings/amend`;
...
const Agent_BookingForm = forwardRef<Agent_BookingFormRef, Agent_BookingFormProps>(
    ({ activeStep, onNextStep, onPrevStep, onComplete }, ref) => {
        ...
        const onSubmit = async (data: Agent_BookingFormData) => {
